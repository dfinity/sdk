...
==== Using GitHub Action
. Head over to https://github.com/dfinity/sdk/actions/workflows/update-replica-version.yml[the GitHub Aciton].
...
# if you want to also ledger canisters for e2e tests, use:
