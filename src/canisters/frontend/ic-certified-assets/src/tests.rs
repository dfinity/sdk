...
use crate::certification::types::http::{HttpRequest, HttpResponse, StreamingStrategy};
...
mod certificate_expression {
    ...
    use crate::certification::types::http::build_ic_certificate_expression_from_headers_and_encoding;
