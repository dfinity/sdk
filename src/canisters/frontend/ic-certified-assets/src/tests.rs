...
mod certification_v2 {
    ...
    fn proper_header_structure() {
        ...
        assert!(cert_header == "version=2, certificate=::, tree=::, expr_path=:2dn3g2lodHRwX2V4cHJtY29udGVudHMuaHRtbGM8JD4=:");
    }
}
