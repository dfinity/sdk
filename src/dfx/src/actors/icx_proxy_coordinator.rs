...
pub struct IcxProxyCoordinator {
    logger: Logger,
    config: Config,
...
impl Actor for IcxProxyCoordinator {
...
impl Handler<signals::PortReadySignal> for IcxProxyCoordinator {
    type Result = ();
...
impl Handler<Shutdown> for IcxProxyCoordinator {
