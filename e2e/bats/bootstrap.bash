...
@test "bootstrap fetches candid file" {
    ...
    assert_command diff .dfx/local/build/hello/hello.did ./web.txt
    ...
    assert_command diff --ignore-all-space --ignore-blank-lines .dfx/local/build/hello/hello.did.js ./web.txt
}
