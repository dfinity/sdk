...
@test "build fails without create" {
    ...
    assert_match "Cannot find canister id. Please issue 'dfx canister --network local create e2e_project'"
}
...
@test "build fails if all canisters in project are not created" {
    ...
    assert_command_fail dfx build
    assert_match "Cannot find canister id. Please issue 'dfx canister --network local create e2e_project_assets'"
}
