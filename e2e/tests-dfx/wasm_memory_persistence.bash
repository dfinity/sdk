...
@test "failing Motoko downgrade from enhanced orthogonal persistence to classical persistence" {
  ...
  assert_match "The \`wasm_memory_persistence: opt Keep\` upgrade option requires that the new canister module supports enhanced orthogonal persistence." "$output"
}
