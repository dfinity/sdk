...
@test "deploy wallet" {
    ...
    dfx canister --network actuallylocal update-settings dummy_canister1 --controller "$(dfx identity get-principal)"
    dfx canister --network actuallylocal update-settings dummy_canister2 --controller "$(dfx identity get-principal)"
