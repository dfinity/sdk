...
@test "error reporting for --wallet parameter" {
  ...
  SETTINGS_DIGEST="$(cat "$E2E_SHARED_LOCAL_NETWORK_DATA_DIRECTORY/network-id" | jq -r .settings_digest)"
  echo "{}" > "$E2E_SHARED_LOCAL_NETWORK_DATA_DIRECTORY/$SETTINGS_DIGEST/wallets.json"
