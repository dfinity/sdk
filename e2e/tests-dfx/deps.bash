...
@test "dfx deps pull can download wasm and candids to shared cache and generate pulled.json" {
  ...
  assert_eq "A natural number, e.g. 10."
...
$CANISTER_ID_A" "$output"
  ...
  assert_eq "4449444c00017103616263"
