...
@test "authorize and deauthorize work as expected" {
  ...
  [ "$USE_IC_REF" ] && dfx canister update-settings --add-controller "$PRINCIPAL" # Dec. 2022: ic-ref has not received the change yet that a canister is always allowed to check it's status
