...
export const canisterId = process.env.WASM-UTILS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wasm-utils.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wasm-utils canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wasm-utils.did.js")._SERVICE>}
 */
export const wasm-utils = createActor(canisterId);
