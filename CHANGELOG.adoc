...
You will need to upgrade each of your existing canisters to work with the new system.  To do so, execute the following command for each of your canisters:
[source, bash]
----
