...
=== fix: canister call uses remote candid file

The candid file specified in the field `canisters.<canister name>.remote.candid` of dfx.json is now used when running `dfx canister call`. It is no longer necessary to always manually specify `--candid <file>` for remote canisters.
...
Updated replica to elected commit 3b5d893c0857c47715fc339112e5dd1dbfff77a8.
