...
DFX will now also delete assets from the container that no longer exist in the project.
This means if you stored assets in the container that are not in the project,
