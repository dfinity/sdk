...
test('IDL encoding', () => {
  ...
  // Unit
  test_(IDL.Unit, null, '4449444c007f', 'Unit value')
  ...
  // Int
  test_(IDL.Int, 42, '4449444c007c2a', 'Int')
  test_(IDL.Int, 1234567890, '4449444c007cd285d8cc04', 'Positive Int')
  test_(IDL.Int, -1234567890, '4449444c007caefaa7b37b', 'Negative Int')

  // Nat
  test_(IDL.Nat, 42, '4449444c007d2a', 'Nat')
  test_(IDL.Nat, 1234567890, '4449444c007dd285d8cc04', 'Positive Nat')
  expect(() => IDL.Nat.encode(-1), 'Wrong Negative Nat').toThrow(/Invalid Nat argument/)

  // Tuple
  test_(IDL.Tuple(IDL.Int, IDL.Text), [42, '💩'], '4449444c016c02007c0171002a04f09f92a9', 'Pairs')
  expect(() => IDL.Tuple(IDL.Int, IDL.Text).encode([0]), 'Wrong Tuple length').toThrow(/Tuple argument has wrong length/)

  // Array
  test_(IDL.Arr(IDL.Int), [0, 1, 2, 3], '4449444c016d7c000400010203', 'Array of Ints')
  ...
  // Array of Tuple
  test_(IDL.Arr(IDL.Tuple(IDL.Int, IDL.Text)), [[42, 'text']], '4449444c026c02007c01716d0001012a0474657874', 'Arr of Tuple')

  // Nested Tuples
  test_(IDL.Tuple(IDL.Tuple(IDL.Tuple(IDL.Tuple(IDL.Unit)))), [[[[null]]]], '4449444c046c01007f6c0100006c0100016c01000203', 'Nested Tuples')

  // Object
  test_(IDL.Obj({}), {}, '4449444c016c0000', 'Empty object')
  expect(() => IDL.Obj({a: IDL.Text}).encode({b: 'b'}), 'Obj is missing key').toThrow(/Obj is missing key/)

  // Test that additional keys are ignored
  testEncode(IDL.Obj({foo: IDL.Text, bar: IDL.Int}), {foo: '💩', bar: 42, baz: 0}, '4449444c016c02d3e3aa027c868eb70271002a04f09f92a9', 'Object')
  testEncode(IDL.Obj({foo: IDL.Text, bar: IDL.Int}), {foo: '💩', bar: 42}, '4449444c016c02d3e3aa027c868eb70271002a04f09f92a9', 'Object')

  // Bool
  test_(IDL.Bool, true, '4449444c007e01', 'true')
  test_(IDL.Bool, false, '4449444c007e00', 'false')
  ...
  test_(Result, { ok: 'good' }, '4449444c016b029cc20171e58eb40271000004676f6f64', 'Result ok')
  test_(Result, { err: 'uhoh' }, '4449444c016b029cc20171e58eb4027100010475686f68', 'Result err')
  ...
  test_(IDL.Variant({ foo: IDL.Unit }), { foo: null }, '4449444c016b01868eb7027f0000', 'Nullary constructor in variant')

  // Test that None within variants works as expected
  test_(IDL.Variant({ ok: IDL.Text, err: IDL.None }), { ok: 'good' }, '4449444c016b029cc20171e58eb4026f000004676f6f64', 'None within variants')
  ...
  // Test for option
  test_(IDL.Opt(IDL.Nat), null, '4449444c016e7d0000', 'Null option')
  test_(IDL.Opt(IDL.Nat), 1, '4449444c016e7d000101', 'Non-null option')

  // Type description sharing
  test_(IDL.Tuple(IDL.Arr(IDL.Int), IDL.Arr(IDL.Nat), IDL.Arr(IDL.Int), IDL.Arr(IDL.Nat)), [[],[],[],[]], '4449444c036d7c6d7d6c0400000101020003010200000000', 'Type sharing')
  ...
  test_(List, null, '4449444c026e016c02a0d2aca8047c90eddae704000000', 'Empty list')
  test_(List, {head: 1, tail: {head: 2, tail: null} }, '4449444c026e016c02a0d2aca8047c90eddae70400000101010200', 'List')
  ...
  test_(List1, null, '4449444c026e016c02a0d2aca8047c90eddae704000000', 'Empty list')
  test_(List1, {head: 1, tail: {head: 2, tail: null} }, '4449444c026e016c02a0d2aca8047c90eddae70400000101010200', 'List')
})
