...
. A tar gz release file containing a distribution versioned with the latest (available) version of the SDK. This tar file includes the versioned CLI, the ActorScript compiler, the node manager and client, and any other necessary binaries.
