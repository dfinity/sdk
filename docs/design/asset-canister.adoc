...
type BatchOperationKind = variant {
  ...
  SetAssetContent: SetAssetContentOperation;

  UnsetAssetContent: UnsetAssetContentOperation;
  DeleteAsset: DeleteAssetOperation;

  SetAssetAcl: SetAssetAclOperation;
  SetAssetExpiry: SetAssetExpiryOperation;
...
service: {
  ...
  create_chunk: (record { batch_id: BatchId; content: blob }) -> (record { chunk_id: nat });

  // Perform all operations successfully, or reject
  batch: (record { batch_id: BatchId; ops: vec BatchOperationKind }) -> ();
