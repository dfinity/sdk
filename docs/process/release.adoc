...
- Using the <<manual,MANUAL release process>> instructions to build and test the release.

[[script]]
== SCRIPT-BASED release process

To use the release script to automate building the release candidate, run the following command:
