...
| [`ping`](./dfx-ping.mdx)         | Sends a response request to the IC or the local development environment to determine network connectivity. If the connection is successful, a status reply is returned. |
...
| [`start`](./dfx-start.mdx)       | Starts the local development environment a web server for the current project.                                                                                          |
