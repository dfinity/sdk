...
Use the `dfx deploy` command to register, build, and deploy a dapp on the local development network, on the IC or on a specified testnet. By default, all canisters defined in the project `dfx.json` configuration file are deployed.
...
| Option                             | Description                                                                                                                                                                                                                                                        |
|------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `--network <network>`              | Overrides the environment to connect to. By default, the local development network is used.                                                                                                                                                             |
...
You can use the `dfx deploy` command to deploy all or specific canisters on the local development network, on the IC or on a specified testnet.
...
To deploy a project on the local development network and pass a single argument to the installation step, you can run a command similar to the following:
