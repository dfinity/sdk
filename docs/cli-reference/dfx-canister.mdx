...
Internet Computer or the local development network. In most cases, you use `dfx canister` subcommands after
...
By default, `dfx canister` commands run on the local development network specified in the `dfx.json` file. If
...
For example, to register unique canister identifiers for a project on the local development network, you can
...
| `--async`                         | Specifies not to wait for the result of the call to be returned by polling the local development network. Instead return a response ID.                                                                                                          |
...
call rather than waiting to poll the local development network or the Internet Computer for the result.
...
Use the `dfx canister delete` command to delete a stopped canister from the local development network or the
...
| `--async-call`                     | Enables you to continue without waiting for the result of the installation to be returned by polling the Internet Computer or the local development network.                                                                                               |
...
a canister on the Internet Computer or on the local development network. The most common use case is to
...
currently stopped on the Internet Computer or on the local development network.
...
Internet Computer or on the local development network.
