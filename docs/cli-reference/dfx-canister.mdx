...
call rather than waiting to poll the local development environment or the Internet Computer for the result.
...
Use the `dfx canister delete` command to delete a stopped canister from the local development environment or the
...
a canister on the Internet Computer or on the local development environment. The most common use case is to
...
currently stopped on the Internet Computer or on the local development environment.
...
Internet Computer or on the local development environment.
