...
| Option                      | Description                                                                                         |
|-----------------------------|-----------------------------------------------------------------------------------------------------|
| `--tail`                    | Specifies to show the last N lines of the logs, use `-N` to specify the number of lines.            |
| `- N <lines>`               | Specifies the number of logs to show for the `--tail` option. Defaults to `10`.                     |
...
``` bash
dfx canister logs hello_world --tail -N 1
```
...
To display the logs in 3 seconds, you can run the following command:
