...
rec {
  ...
  install-sh = pkgs.lib.writeCheckedShellScriptBin "activate" [] ''
    ...
    s3cp "${../public/sdk-license-agreement/index.txt}" "sdk/sdk-license-agreement.txt" "plain/text" "$do_not_cache"
    s3cp "${../public/tungsten-license-agreement.txt}" "sdk/tungsten-license-agreement.txt" "plain/text" "$do_not_cache"
    s3cp "${../public/sodium-license-agreement.txt}" "sdk/sodium-license-agreement.txt" "plain/text" "$do_not_cache"
